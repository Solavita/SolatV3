...
| Foundation benchmark | PASS | `node scripts/evaluate-model-foundation.js` | `19 PASS`, `0 FAIL`, `6 NOT VERIFIED` | `evaluations/model-foundation-benchmark-v1.json`; `src/core/conversation-evaluator.js` | Remaining cases require semantic model evidence; no parity claim |
